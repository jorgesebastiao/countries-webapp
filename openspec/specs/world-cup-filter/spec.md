# world-cup-filter Specification

## Purpose

Home page filter by FIFA World Cup edition, composing with the existing search/region filters, with host and champion highlighting on country cards.
